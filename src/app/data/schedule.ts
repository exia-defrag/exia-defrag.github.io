...
export const ScheduleData: Array<ISchedule> = [
  { id: 1, day: "Monday", time: "22:00 (GMT +8)", title: "Miscellaneous Mondays", description: "I'll play a random game from my library.", },
  {
    id: 2, day: "Friday", time: "22:00 (GMT +8)", title: "Pokemon Inclement Emerald Monolocke", description: "Join me as I attempt to clear Pokemon Inclement Emerald with Monolocke Rules.",
    scheduleLinks: [
  ...
  { id: 3, day: "Saturday", time: "22:00 (GMT +8)", title: "Viewer Duels and Ranked @ Yu-Gi-Oh Master Duel", description: "Let's play! Or just watch me ladder on ranked.", },
